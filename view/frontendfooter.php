  	...
  	<footer class="py-3 mt-5">
    	<div class="container">
    		<div class="text-center pb-3">
      		...
      		<p class="m-0 text-center text-white">Copyright &copy; <img src="<?php echo $GLOBALS['view_path'] ?>template/logo/logo_wh_transparent.png" style="width: 30px; height: 30px"> 2019</p>
    	</div>
  	</footer>
